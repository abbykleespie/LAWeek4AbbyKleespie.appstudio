...
const cacheName = 'LAWeek4AbbyKleespie-2021-02-24 15:07:13.046700'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4AbbyKleespie'.length) === 'LAWeek4AbbyKleespie') {
